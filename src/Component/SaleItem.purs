...
component = React.createComponent "SaleItem"
...
saleItem :: Props -> React.JSX
saleItem = React.makeStateless component \props@{ sale: Sale sale } ->
          ...
          , div
            ...
            , children:
              [ button
                ...
                , onClick: Events.handler_ $ props.toggleFavorite sale.id
                }
              ,  if isFavorited
